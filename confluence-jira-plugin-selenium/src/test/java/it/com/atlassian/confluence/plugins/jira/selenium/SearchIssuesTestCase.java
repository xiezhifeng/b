...
public class SearchIssuesTestCase extends AbstractJiraPanelTestCase
{
    ...
    public void testSearchWithFilterHaveJQL()
    {
        ...
        client.typeKeys("css=input[name='jiraSearch']", JIRA_DISPLAY_URL + "/issues/?filter=10000");
    ...
    public void testSearchWithFilterEmptyJQL()
    {
        ...
        client.typeKeys("css=input[name='jiraSearch']", JIRA_DISPLAY_URL + "/issues/?filter=10001");
    ...
    public void testSearchWithFilterNotExist()
    {
        ...
        client.typeKeys("css=input[name='jiraSearch']", JIRA_DISPLAY_URL + "/issues/?filter=10002");
