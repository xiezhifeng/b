...
/**
 * This class contains tests for search issue, check option table/count, input
 * value columns
 */
public class CreateMacroLinksTestCase extends AbstractJiraPanelTestCase {
    ...
    public void testCreateLinkMacroWithParamCount() {
        ...
        final String contentId = client
                .getEval("window.AJS.Confluence.Editor.getContentId()");
        ...
        String numberCount = client
                .getText("css=#main-content .jiraissues_count");
    ...
    /**
     * input value to columns field in macro dialog and insert macro link in the
     * Editor Check param column of macro placeholder in Editor
     */
    ...
    /**
     * input value to columns field in macro dialog and insert macro link in the
     * Editor, create page with this macro and Edit page check macro param
     * columns
     */
    ...
    public void testSearchNoResult() {
        ...
        String resultNoResult = client
                .getText("css=#my-jira-search .data-table .aui-message");
    ...
    public void testDisableOption() {
        ...
        assertThat.attributeContainsValue("css=input[name='columns-display']",
                "disabled", "true");
    ...
    private void searchAndInsertLinkMacroWithParam(String paramName,
            String searchStr, String... expected) {
        client.click("//li/button[text()='Search']");
        ...
        for (int i = 0; i < expected.length; i++) {
            assertEquals(
                    expected[i],
                    client.getTable("css=#my-jira-search table.my-result."
                            + (i + 1) + ".1"));
        }
