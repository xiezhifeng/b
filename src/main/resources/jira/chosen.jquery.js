...
(function() {
  ...
  Chosen = (function(_super) {
    ...
    Chosen.prototype.set_up_html = function() {
      ...
      if (this.is_multiple) {
        this.container.html('<ul class="chzn-choices"><li class="search-field"><input type="text" value="' + this.default_text + '" class="default" autocomplete="off" style="width:90px;" /></li></ul><div class="chzn-drop"><ul class="chzn-results"></ul></div>');
      } else {
    ...
    Chosen.prototype.keydown_backstroke = function() {
      ...
      console.log("keydown_backstroke");
