 ...
 */
public class SteamableJiraIssuesMacro extends JiraIssuesMacro implements StreamableMacro, EditorImagePlaceholder, ResourceAware
{
    
    private static final Logger LOGGER = Logger.getLogger(SteamableJiraIssuesMacro.class);
    ...
    private static class JIMFutureTask<V> implements Callable<V> {
        ...
        private final SteamableJiraIssuesMacro jim;
        
        public JIMFutureTask(Map parameters, ConversionContext context, SteamableJiraIssuesMacro jim)
        {
