...
public class TwoDimensionalChartDialogAbstract extends AbstractAbstractJiraChartDialog
{
    ...
    public TwoDimensionalChartDialogAbstract inputJqlSearch(String val)
    {
