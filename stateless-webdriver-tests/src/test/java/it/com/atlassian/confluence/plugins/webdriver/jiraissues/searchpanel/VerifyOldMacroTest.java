...
public class VerifyOldMacroTest extends AbstractJiraIssuesSearchPanelTest
{
    ...
    public void testConvertJiraIssueToJiraWithXML()
    {
        ...
        assertThat(getMacroParams(editPage, OLD_JIRA_ISSUE_MACRO_NAME), containsString("jqlQuery= project \\= TP"));
    }
    ...
    public void testConvertJiraIssueToJiraWithKey() {
        ...
        assertThat(getMacroParams(editPage, OLD_JIRA_ISSUE_MACRO_NAME), containsString("key=TP-1"));
    }
    ...
    public void testConvertJiraIssueToJiraWithColumns()
    {
        ...
        assertThat(getMacroParams(editPage, OLD_JIRA_ISSUE_MACRO_NAME), containsString("columns=key,summary,type"));
    }
    ...
    public void testConvertJiraIssueToJiraWithCount()
    {
        ...
        assertThat(getMacroParams(editPage, OLD_JIRA_ISSUE_MACRO_NAME), containsString("count=true"));
    }
