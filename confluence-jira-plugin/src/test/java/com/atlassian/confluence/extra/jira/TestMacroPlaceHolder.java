...
public class TestMacroPlaceHolder extends TestCase
{
    ...
    public void testGenerateImagePlaceholderWithCount() throws Exception
    {
        ...
        final URI uri = new URI("localhost:1990/jira");
        String url = "/sr/jira.issueviews:searchrequest-xml/temp/SearchRequest.xml?jqlQuery=";

        final ApplicationId applicationId = new ApplicationId("8835b6b9-5676-3de4-ad59-bbe987416662");
        ...
        final JiraIssuesManager.Channel channel = mock(JiraIssuesManager.Channel.class);
        ...
        final ImagePlaceholder defaultImagePlaceholder = jiraIssuesMacro.getImagePlaceholder(parameters, null);
    ...
    public void testGetTableImagePlaceholder()
    {
        ...
        final ImagePlaceholder imagePlaceholder = jiraIssuesMacro.getImagePlaceholder(parameters, null);
