...
public class TestJiraIssuesMacro extends TestCase
{
    ...
    public void testPrepareDisplayColumns()
    {
        ...
        assertEquals(defaultColumns,jiraIssuesMacro.getColumnInfo(jiraIssuesMacro.getColumnNames(""), columns));

        // make sure get columns properly
        assertEquals(threeColumns, jiraIssuesMacro.getColumnInfo(jiraIssuesMacro.getColumnNames("key,summary,assignee"), columns));
        assertEquals(threeColumns, jiraIssuesMacro.getColumnInfo(jiraIssuesMacro.getColumnNames("key;summary;assignee"), columns));
    ...
    public void testColumnWrapping() 
    {
        ...
        List<JiraColumnInfo> columnInfo = jiraIssuesMacro.getColumnInfo(jiraIssuesMacro.getColumnNames(null), new HashMap<String, JiraColumnInfo>());
