...
public class TestJiraRemoteLinkCreator  extends TestCase
{
    public void testGetAppLinkByMacroDefinition()
    {
        ...
        JiraRemoteLinkCreatorMock objToTest = new JiraRemoteLinkCreatorMock(applicationLinkService, hostApplication, settingsManager, finderService, requestFactory, factory);
    ...
    private class JiraRemoteLinkCreatorMock extends JiraRemoteLinkCreator
    {
        ...
        {
            super(applicationLinkService, hostApplication, settingsManager, finderService, requestFactory, executorFactory);
        }
