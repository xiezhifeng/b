AJS.Editor.JiraChart = (function($) {
    ...
    var bindActionInDialog = function($container) {
        ...
        $container.find("#jira-timeline-width").focusout(function(event) {
    ...
    var getMacroParamsFromDialog = function(container) {
        ...
        return {
            ...
            groupBy: container.find('#jira-timeline-group-by').val(),
            width: convertFormatWidth(container.find('#jira-timeline-width').val()),
