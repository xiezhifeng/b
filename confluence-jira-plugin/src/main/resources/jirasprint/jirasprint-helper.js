AJS.Editor.JiraSprint.Helper = (function($) {
    ...
    var convertSearchTextToJQL = function (container) {
        var servers = AJS.Editor.JiraConnector.servers;
        var serverId;
        var textSearch = container.find("#jira-sprint-search-input").val();
        ...
        if (jql) {
            container.find("#jira-sprint-search-input").val(jql);
        } else {
            container.find(".jira-sprint-img").html(Confluence.Templates.ConfluenceJiraPlugin.jqlInvalid());
            AJS.Editor.JiraChart.disableInsert();
        }
        return jql;
    };
    ...
    var bindingCommonChartElements = function(container) {
        return {
            jql: container.find('#jira-sprint-search-input'),
            width: container.find('#jira-sprint-width'),
            border: container.find('.jira-sprint-show-border'),
            showinfor: container.find('.jira-sprint-show-infor'),
            displayOption: container.find('.jirasprint-display-opts-close, .jirachart-display-opts-open'),
            server: container.find('#jira-sprint-servers')
        };
    };
