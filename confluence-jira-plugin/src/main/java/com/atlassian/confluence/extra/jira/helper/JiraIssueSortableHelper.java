...
public class JiraIssueSortableHelper
{
    ...
    public static final long SUPPORT_JIRA_BUILD_NUMBER = 6251L; // should be change to build number of JIRA when it takes the fix on REST API to support sorting into account.
