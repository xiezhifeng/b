...
public interface AsyncJiraIssueBatchService
{
     ...
     */
    void reprocessRequest(String clientId, String serverId, Set<String> keys, List<MacroDefinition> macroDefinitions, ConversionContext conversionContext);
    ...
    /**
     * <p>Retrieve data generated by {@link #reprocessRequest}.</p>
     *
