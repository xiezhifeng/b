...
public interface AsyncJiraIssueBatchService
{
     ...
     *
     * @param entityServerCompositeKey the key used to store data
     ...
     */
    void processRequest(EntityServerCompositeKey entityServerCompositeKey, Set<String> keys, List<MacroDefinition> macroDefinitions, ConversionContext conversionContext);

    /**
     * <p>Retrieve data generated by {@link #processRequest}.</p>
     *
     * @param entityServerCompositeKey the key used to retrieve data
     * @return response data (which has been transform to html) from Jira
     * @throws Exception
     */
    JiraResponseData getAsyncJiraResults(EntityServerCompositeKey entityServerCompositeKey) throws Exception;
}
