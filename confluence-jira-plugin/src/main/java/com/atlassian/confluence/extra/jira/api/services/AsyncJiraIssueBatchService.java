...
public interface AsyncJiraIssueBatchService
{
    ...
    void processRequestTable(final ClientId clientId, final Map<String, String> macroParams, final Map<String, Object> contextMap, final ConversionContext conversionContext,
                             ...
                             final ReadOnlyApplicationLink appLink, boolean forceAnonymous, boolean useCache) throws CredentialsRequiredException, IOException, ResponseException, MacroExecutionException;
