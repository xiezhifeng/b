...
public interface AsyncJiraIssueBatchService
{
     ...
     *
     * @param clienId                  the key used to store data
     ...
     */
    void processRequest(Long clienId, String serverId, Set<String> keys, List<MacroDefinition> macroDefinitions, ConversionContext conversionContext);
     ...
     * @throws Exception
     */
    JiraResponseData getAsyncJiraResults(Long clientId) throws Exception;
}
