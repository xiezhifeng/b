 ...
 */
public class StreamableSingleIssueMacroFutureTask implements Callable<String>
{
    ...
    public StreamableSingleIssueMacroFutureTask(Map<String, String> parameters, ConversionContext context, StreamableMacro macro, ConfluenceUser user)
    {
    ...
    public StreamableSingleIssueMacroFutureTask(Map<String, String> parameters, ConversionContext context, StreamableMacro macro, ConfluenceUser user, Element element, String jiraServerUrl, Exception exception)
    {
        this.parameters = parameters;
        this.context = context;
        this.macro = macro;
