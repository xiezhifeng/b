...
public class SingleJiraIssuesToViewTransformer implements Transformer {
    ...
    private JiraMacroFinderService getJiraMacroFinderService() {
        return jiraMacroFinderService;
    }
    ...
    public String transform(Reader reader, ConversionContext conversionContext) throws XhtmlException {
        ...
        try {
            ...
            final Set<MacroDefinition> macroDefinitions = getJiraMacroFinderService().findJiraIssueMacros(body, conversionContext, keyPredicate);
...
//                SingleJiraIssuesMapThreadLocal.put()
            }
