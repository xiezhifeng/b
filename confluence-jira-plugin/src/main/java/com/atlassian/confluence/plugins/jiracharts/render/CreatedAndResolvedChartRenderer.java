...
public class CreatedAndResolvedChartRenderer extends JiraImageChartRenderer
{
    ...
    public CreatedAndResolvedChartRenderer(final ContextPathHolder pathHolder, final Base64JiraChartImageService base64JiraChartImageService)
    {
